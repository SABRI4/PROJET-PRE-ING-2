...
#depart chrono / Chemin complet du fichier CSV
...
' "$csv_file" | sort -nrk1,1 | head -n 10 | sort -nk2,2nr > "data/top_trajets.dat"
...
plot 'data/top_trajets.dat' using 1:xtic(2) notitle lc rgb "green"
